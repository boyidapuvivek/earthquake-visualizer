      ...
      <div className='absolute bottom-6 right-6 z-20'>
        <div className='gap-5'>
          <button
            ...
            className='p-3 hover:bg-blue-50 active:scale-95 transition-all duration-200 border-b border-slate-200 flex items-center justify-center'>
            <Plus className='w-5 h-5 text-blue-600' />
          </button>
          <button
            onClick={() => mapRef.current?.zoomOut()}
            className='p-3 hover:bg-blue-50 active:scale-95 transition-all duration-200 flex items-center justify-center'>
