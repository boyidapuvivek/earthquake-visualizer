...
export default function App() {
  ...
  return (
    <div className='min-h-screen w-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 relative overflow-hidden'>
      ...
      <div className='relative z-10 h-screen flex flex-col'>
        {/* Main Content Area */}
        <main className='flex flex-col min-h-0 relative flex-1'>
          {/* Top Navigation Bar */}
          <nav className='flex items-center justify-between gap-4 p-4 sm:p-6 relative z-30'>
            ...
            {/* Right Section - Could be used for additional controls */}
